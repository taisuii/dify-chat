...
**版本说明**：当前 @dify-chat/* 0.7.8、@dify-chat/widget 0.1.9。v0.1.8 恢复 containerMinHeight 默认 calc、侧边栏 188px；v0.1.9 去除主内容区顶部圆角。若 Next.js 构建仍因 CJS context require 报错，可显式使用：`import { DifyChat } from '@dify-chat/widget/dist/index.js'`。
